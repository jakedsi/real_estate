  ...
  return (
    <div className='py-[10vh] bg-[#F2F2F2]'>
        <div className='flex justify-center'>
            <div className='w-[900px] flex justify-between gap-[5rem] items-center md:flex-col md:gap-2'>
                <h1 className='text-[30px] text-[#030E47] font-semibold text-center'>Latest Housing Information</h1>
        ...
        <div className='flex justify-center mt-[5vh]'>
            <div className='w-[900px] flex flex-wrap gap-5 justify-around'>
                <div className='w-[30%] h-[320px] flex flex-col p-2 justify-start items-start sm:w-[300px] 1xs:w-full 1xs:px-3'>
