  ...
  return (
    <nav>
        <div className='flex justify-between px-5 absolute w-full py-5 text-white items-center'>
            ...
            <div className={nav ? 'hidden md:flex flex-col gap-1 z-10 cursor-pointer absolute right-[15px]' : 'hidden md:flex flex-col gap-1 z-10 cursor-pointer fixed right-[15px]'} onClick={()=>navIsActive(prev => !prev)}>
