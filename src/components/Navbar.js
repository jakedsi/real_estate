  ...
  return (
    <nav>
        <div className='flex justify-between px-5 absolute w-full py-5 text-white items-center'>
            ...
            <ul className={nav ? 'flex text-[15px] gap-10 font-light md:fixed md:right-0 md:top-0 md:h-screen md:bg-[#393a37] md:w-[250px] md:z-10 md:pt-[10vh] md:flex-col md:items-center md:justify-start md:translate-x-full md:transition md:duration-500' : 'flex text-[15px] gap-10 font-light md:fixed md:right-0 md:top-0 md:h-screen md:bg-[#393a37] md:w-[250px] md:z-10 md:pt-[10vh] md:flex-col md:items-center md:justify-start md:translate-x-0 md:transition md:duration-500'}>
                ...
                <div className='md:flex flex-col-reverse font-light text-[12px] gap-3 hidden my-5'>
            ...
            <div className='flex font-light text-[14px] gap-3 md:hidden'>
                ...
                <button className='px-5 py-2 bg-blue-500 rounded-lg'>Signup</button>
            </div>
            <div className={nav ? 'hidden md:flex flex-col gap-1 z-20 cursor-pointer absolute right-[15px]' : 'hidden md:flex flex-col gap-1 z-20 cursor-pointer fixed right-[15px]'} onClick={()=>navIsActive(prev => !prev)}>
